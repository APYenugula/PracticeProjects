...
namespace efnew3.Controllers
{
    public class CustomersController : Controller
    {
        private readonly AdoNetPracticeContext _context;

        public CustomersController(AdoNetPracticeContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
            return _context.Customers != null ?
              ...
              base.View(await FillData()) :
                        base.Problem("Entity set 'AdoNetPracticeContext.Customers'  is null.");
        }
        ...
        private async Task<List<Customer>> FillData()
        {
            ...
            {
                customerData[i++].FullName = customer.FirstName + " " + customer.LastName;
            }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'AdoNetPracticeContext.Customers'  is null.");
            }
            var customer = await _context.Customers.FindAsync(id);
            if (customer != null)
            {
